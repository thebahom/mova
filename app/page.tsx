...
export default function Home() {
  ...
  return <div className="immersive-shell">
    ...
    <main>
      ...
      <section className="final-cta"><Reveal><div className="section-index">04 / START HERE</div><h2>Wherever you’re going,<br/><em>start with what’s next.</em></h2><Link className="pill light large" href={href as any}>BUILD MY JOURNEY <ArrowRight size={15}/></Link></Reveal></section>
    </main>
